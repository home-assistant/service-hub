/**
 * Per-label reporting guidance shown on the issue dashboard, ported from the
 * legacy bot's `data/github/issue_context.yaml`. The generic duplicate-check
 * message lives in the dashboard's issue intro, not here.
 */
export const coreIssueContext: Record<string, string> = {
  "custom integration":
    "Hey, thank you for taking the time to report this! 🙏\n\n" +
  ...
  "integration: demo": "This is a demo integration.",
  "integration: enphase_envoy":
    ...
    "To help us troubleshoot, please include the following information in your report:\n\n" +
  ...
  "integration: shelly":
    ...
    "If your issue is related to **battery powered** Shelly generation 2+ (Plus, Gen3 or Gen4) device, make sure you have configured [Outbound WebSocket](https://www.home-assistant.io/integrations/shelly/#shelly-device-configuration-generation-2) correctly.\n\n" +
  ...
  "integration: unifi_access":
    ...
    "1. UniFi OS version\n" +
    "2. Access version\n" +
    "3. Hardware running Access (Cloud Key Gen2+, UDM-Pro, etc.)\n" +
    "4. UniFi Access Hub model and firmware version\n" +
    "5. [If applicable, error logs](https://www.home-assistant.io/docs/configuration/troubleshooting/#debug-logs-and-diagnostics)",
  ...
  "integration: zha":
    ...
    "4. Fill out the issue template and include whether or not you're using a VM/Proxmox with USB passthrough, what addons you have installed, and so on.\n\n" +
