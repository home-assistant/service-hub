...
import { applyOverrides, parseOverrides } from "../../src/utils/rule-overrides.js";
...
describe("applyOverrides", () => {
  ...
  it("downgrades fail to skip and appends the reason while preserving the original message", () => {
